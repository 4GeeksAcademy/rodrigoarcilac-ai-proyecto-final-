const i18n = {
  es: {
    ...
    "labels.patient_id": "ID de paciente (opcional)",
    ...
    "help.patient_id": "Formato: HC- + 6 caracteres alfanuméricos.",
  ...
  en: {
    ...
    "labels.patient_id": "Patient ID (optional)",
    ...
    "help.patient_id": "Format: HC- + 6 alphanumeric characters.",
